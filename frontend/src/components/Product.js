...
function Product({ staticImage, dynamicImage, name, price, monthDelivery }) {
    ...
    return (
        <Card
            className="card-product border-0 my-5 px-2"
            ...
            <Button className="btn-small" variant="light" as={Link} to="/shoplaal">
                Shop now
            </Button>
        </Card>
    );
